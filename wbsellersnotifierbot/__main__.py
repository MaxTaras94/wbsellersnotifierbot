...
def main():
    ...
    application.add_handler(CallbackQueryHandler(handlers.unpin_all_messages_accept, pattern="accept_unpin_msg"))
    ...
    application.add_handler(CallbackQueryHandler(handlers.unpin_all_messages_start, pattern="unpin_all_messages_start"))
